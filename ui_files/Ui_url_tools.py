...
"}")
        ...
        self.submit_web_button.setEnabled(False)
...
"}")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 390, 481, 221))
...
"}")
        ...
        self.analytics_and_config_tab_widget.setCurrentIndex(1)
...
"Requires a wordlist to be used"))
        ...
        self.submit_web_button.clicked.connect(self.on_submit_web_button_clicked)
    ...
    def on_submit_web_button_clicked(url_target_textedit, webpage_view_tabwidget):
        # Get the URL from url_target_textedit
