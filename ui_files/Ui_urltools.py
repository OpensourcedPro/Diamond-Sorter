...
"}")
        ...
        self.url_scan_api_button = QtWidgets.QPushButton(UrlToolsWindow)
        self.url_scan_api_button.setGeometry(QtCore.QRect(240, 540, 91, 31))
...
"Requires a wordlist to be used"))
        ...
        self.gather_subdomain_hijack_button.clicked.connect(on_gather_subdomain_hijack_clicked)

    def on_gather_subdomain_hijack_clicked():
        # Create an instance of the subdomaincenter class
        center = subdomaincenter()
    
        # Get the target URL from url_target_textedit
        target_url = url_target_textedit.toPlainText()
    
        # Call the request_url function to fetch the subdomains
        response = await center.request_url(target_url)
    
        # Parse the results from the response
        subdomains = center.parse_results(response, target_url)
    
        # Display the results in results_window_textedit_3
        results_window_textedit_3.setPlainText('\n'.join(subdomains))
    ...
    def simalar_web_button_function(self):
        ...
        try:
            ...
            # Process the response and extract similar domains by ranks and hits
            # ...
            
            # Example code to print the URL and similar domains
            print("URL:", url)
    ...
    def seo_data_details_button_function(self):
        ...
        try:
            ...
            # Example code to print the URL and SEO data
            print("URL:", url)
            print("SEO Data:")
            # ...
