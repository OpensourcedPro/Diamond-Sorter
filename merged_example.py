...
init(autoreset=True)
print("Initializing")
msg0 = "Please Wait While It Loads........\n"
msg0 = "DiamondSorter is apart of the DiamondPrograms Collection Brought To You By Opensourced.Pro\n"
sleep(2)
for i in msg0:
    sys.stdout.write(i)
    sys.stdout.flush()
...
#f = open("https://opensourced.pro/account/diamond_programs/DiamondSorterv1.8.3.rar", "wb")
#f.write(bytes)
#f.close()
...
print(f"Current Session Validation Status: {keyauthapp.check()}")
print("Launching Diamond Software in 5 secs....")
sleep(5)

# Launch diamondsorter.py

diamondsorter_path = "diamondsorter.py"
subprocess = Popen(['pythonw', diamondsorter_path])
os.startfile(diamondsorter_path)

print("Launching Diamond Software in 5 secs....")
print("You May Close This Window When The Software Launches.")
