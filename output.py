...
from button_actions import captcha_button_clicked, cloudflare_button_clicked, akamai_button_clicked
...
"}")
        ...
        self.javascript_links_button = QtWidgets.QPushButton(self.tab)
        ...
        self.xpath_login_field_textedit = QtWidgets.QTextEdit(self.tab_2)
        ...
        self.xpath_password_field_textedit = QtWidgets.QTextEdit(self.tab_2)
        ...
        self.analytics_and_config_tab_widget.addTab(self.tab_2, "")
...
"}")
        ...
        self.Website_Source_Code.addTab(self.WebsiteSourceCodeTab, "")
        ...
        self.console_data_treeView.setGeometry(QtCore.QRect(0, 0, 421, 271))
        self.console_data_treeView.setObjectName("console_data_treeView")
        self.Website_Source_Code.addTab(self.console_data_treeTab, "")
...
"Requires a wordlist to be used"))
        ...
        self.analytics_and_config_tab_widget.setTabText(self.analytics_and_config_tab_widget.indexOf(self.tab_2), _translate("UrlToolsWindow", "Quick Brute"))
