...
class GeneralTab(QWidget):
    ...
    def setup_buttons(self):
        ...
        button_texts = ["Copy Output", "Remove Ending Punctuation", "Remove Domains", "Remove Duplicates",
                        "Remove Special Character", "Extract MD5", "Replace with List", "Paste Input", "Split by Lines"]
        button_functions = [self.copy_output, self.remove_ending_punctuation, self.remove_domains,
                            self.remove_duplicates, self.remove_special_character, self.extract_md5,
                            self.replace_with_list, self.paste_input, self.split_by_linesButton]
        ...
        # Set the layout for the GeneralTab widget
        ...
        self.copy_output = general_tab.copy_output
        self.remove_ending_punctuation = general_tab.remove_ending_punctuation
        self.remove_domains = general_tab.remove_domains
        self.remove_duplicates = general_tab.remove_duplicates
        self.remove_special_character = general_tab.remove_special_character
        self.extract_md5 = general_tab.extract_md5
        self.replace_with_list = general_tab.replace_with_listButton
        self.paste_input = general_tab.paste_input
        self.split_by_lines = general_tab.split_by_linesButton
